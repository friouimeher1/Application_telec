...
<!-- jQuery -->
<script src="{{URL::asset('backend/js/jquery-2.1.4.min.js')}}"></script>
<!-- //jQuery -->
<link href='//fonts.googleapis.com/css?family=Roboto:700,500,300,100italic,100,400' rel='stylesheet' type='text/css'/>
<link href='//fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'>
<!-- lined-icons -->
<link rel="stylesheet" href="{{URL::asset('backend/css/icon-font.min.css')}}" type='text/css' />
<!-- //lined-icons -->
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">
												<span class="prfil-img"><img src="{{URL::asset('backend/images/in4.jpg')}}" alt=""> </span>
												<div class="user-name">
													<p>Bienvenue</p>
										...
										<ul class="dropdown-menu drp-mnu">
											<li> <a href="#"><i class="fa fa-cog"></i> Paramétre</a> </li>
				...
				<div class="sidebar-menu">
					<header class="logo1">
						...
						<div style="border-top:1px ridge rgba(255, 255, 255, 0.15)"></div>
                           <div class="menu">
									<ul id="menu" >
										<li><a href="{{route('admin.home')}}"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>


										 <li id="menu-academico" ><a href="{{ route('message') }}"><i class="fa fa-envelope nav_icon"></i><span>Messages</span><div class="clearfix"></div></a></li>
									<li><a href="{{ route('post.index') }}"><i class="fa fa-picture-o" aria-hidden="true"></i><span>Promotion</span><div class="clearfix"></div></a></li>
									<li id="menu-academico" ><a href="{{ route('gereclient.index') }}"><i class="fa fa-bar-chart"></i><span>Gérer Client</span><div class="clearfix"></div></a></li>
									 <li id="menu-academico" ><a href="#"><i class="fa fa-list-ul" aria-hidden="true"></i><span> </span> Gérer Boutique<span class="fa fa-angle-right" style="float: right"></span><div class="clearfix"></div></a>
										   <ul id="menu-academico-sub" >
										   <li id="menu-academico-avaliacoes" ><a href="#">Icons</a></li>
											<li id="menu-academico-avaliacoes" ><a href="#">Typography</a></li>
